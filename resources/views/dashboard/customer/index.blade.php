        ...
        <section class="grid gap-6 lg:grid-cols-12">
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 lg:col-span-5 flex flex-col justify-between">
                ...
                <div class="mt-6 pt-4 border-t border-slate-100 flex flex-col gap-2">
                    <a href="{{ route('reviews') }}" class="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#c9a227] px-4 py-2.5 text-xs font-bold text-white hover:bg-[#b68d1f] shadow-sm transition">
                        <span>⭐ Lihat Semua &amp; Tulis Ulasan</span>
                    </a>
