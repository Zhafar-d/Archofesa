<aside class="w-64 border-r border-[#e7e2d8] bg-white p-6">
    <nav class="space-y-2">
        ...
        <a href="{{ route('profile.edit') }}" class="group flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-50 hover:text-slate-900">
            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
