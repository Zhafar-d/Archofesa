...
<head>
    ...
    <title>@yield('title', 'Owner · ARCHOFESA KOST')</title>
    ...
    <aside x-show="sidebarOpen"
        ...
        <div class="flex items-center justify-between border-b border-[#e7e2d8] px-6 py-5">
            <div>
                ...
                <p class="text-xs font-semibold tracking-wider text-[#6b7280]">Owner Panel</p>
            </div>
        ...
        <nav class="flex-1 space-y-1 overflow-y-auto p-4">
            @php
                $ownerNav = [
                    ...
                    ['route' => 'owner.kamar.index',      'label' => 'Manajemen Kamar',      'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
                    ['route' => 'owner.konfirmasi.index', 'label' => 'Konfirmasi Booking',   'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ['route' => 'owner.laporan.index',    'label' => 'Laporan Keuangan',     'icon' => 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                    ['route' => 'owner.chat',             'label' => 'Chat Admin',           'icon' => 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'],
                ];
            @endphp

            @foreach($ownerNav as $nav)
            ...
            <div class="flex items-center gap-3 rounded-xl bg-[#faf8f5] px-4 py-3">
                <a href="{{ route('profile.edit') }}" class="flex min-w-0 flex-1 items-center gap-3 transition hover:opacity-80" title="Lihat Profil">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="truncate text-sm font-semibold text-[#1f2937]">{{ auth()->user()->name ?? 'Owner' }}</p>
                        <p class="truncate text-xs text-[#6b7280]">Owner / Pemilik</p>
                    </div>
                </a>
        ...
        <header class="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-[#e7e2d8] bg-white/90 px-4 backdrop-blur lg:hidden">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[10px] font-medium text-slate-500">Owner Panel</p>
                </div>
            </div>
